...
public class IndexAccessorFactory {
	...
	/**
	 * name of 10x launch argument containing cloud accessor class name.
	 * To learn more, see: {@link https://doc.log10x.com/run/input/objectStorage/#objectstorageclassname} 
	 */
	public static final String OBJECT_STORAGE_ACCESS_CLASS_ENV = "objectStorageClassName";
	
	public static final char ACCESS_ALIAS_SEPERATOR = ':';
	...
	public static ObjectStorageIndexAccessor createIndexAccessor(EvaluatorBean evaluator,
		...
		for (Object accessClass : accessClasses) {
			...
			int index = accessClassStr.indexOf(ACCESS_ALIAS_SEPERATOR);
			
			if (index == -1) {
				throw new IllegalStateException("missing '" + ACCESS_ALIAS_SEPERATOR + "' in: " + accessClassStr);
			}
